...
const LIVE_WOW_BUILD_NUMBER = '12.0.1.66527';
...
const classes: { [classId: number]: { name: string; baseMaxResource: number } } = {
  ...
  2: { name: 'Paladin', baseMaxResource: 250_000 },
  3: { name: 'Hunter', baseMaxResource: 100 },
  4: { name: 'Rogue', baseMaxResource: 100 },
  5: { name: 'Priest', baseMaxResource: 250_000 },
  6: { name: 'Death Knight', baseMaxResource: 1000 },
  7: { name: 'Shaman', baseMaxResource: 250_000 },
  8: { name: 'Mage', baseMaxResource: 250_000 },
  9: { name: 'Warlock', baseMaxResource: 250_000 },
  10: { name: 'Monk', baseMaxResource: 250_000 },
  11: { name: 'Druid', baseMaxResource: 250_000 },
  12: { name: 'Demon Hunter', baseMaxResource: 100 },
  13: { name: 'Evoker', baseMaxResource: 250_000 },
};
...
function nodeEntries(node: TalentNode): TalentEntry[] {
  if (node.type !== ClassNodeType.Single) {
    return node.entries;
  } else {
